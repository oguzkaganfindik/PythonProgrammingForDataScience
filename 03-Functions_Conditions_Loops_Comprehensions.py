...
# Çift indextekileri bir listeye, tek indextekileri diğer listeye almak
...
# öyle bir fonksiyon yazmalıyız ki,
# kendisine girilen string ifadelerin çift indexlerinde yer alan karakterleri büyütsün
# tek indexlerinde yer alan karakterleri küçültsün
...
# lambda, map, filter, reduce: vektör seviyesinde işlemler yapma yönüne hitap eden bazı araçlar
